"""
Django settings for metabase_agent project.
...
ROOT_URLCONF = "metabase_agent.urls"
...
WSGI_APPLICATION = "metabase_agent.wsgi.application"
ASGI_APPLICATION = "metabase_agent.asgi.application"
...
LOGGING = {
    ...
    "loggers": {
        ...
        for logging_app in INSTALLED_APPS + ["metabase_agent", "django"]
    },
    "root": {
        "level": "INFO",
